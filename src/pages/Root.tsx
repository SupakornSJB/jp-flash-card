...
import { ASSET_OBJ, EnabledSetListContext } from "../hooks/useGREMultiList";
...
const Root: React.FC = () => {
  ...
  const enabledSetContext = useState<string[]>(() => Object.keys(ASSET_OBJ));
  ...
  return (
    <>
      <EnabledSetListContext.Provider value={enabledSetContext}>
      ...
      </EnabledSetListContext.Provider>
    </>
  )
}
